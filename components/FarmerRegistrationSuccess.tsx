...
const FarmerRegistrationSuccess: FC<IProps> = ({
  isDialogOpen,
  handleDialogClose,
  setIsDialogOpen,
}) => {
      ...
      <AlertDialogContent>
        ...
        <div className="flex flex-col items-center justify-center gap-6 text-center">
          <AlertDialogDescription className="w-2/3 pt-2 font-medium sm:w-3/5">
            Farmer has been successfully registered! They will now receive
            AI-powered agricultural advice and weather alerts via WhatsApp.
          </AlertDialogDescription>

          <CopyLink link="Farmer ID: FARM001234" />
...
export default FarmerRegistrationSuccess;
